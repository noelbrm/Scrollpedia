      ...
      <div className="mx-auto min-h-dvh w-full max-w-md px-5 pb-10 pt-5">
        ...
        <div className="space-y-6">
          <div>
            ...
            <h1
              className={`mt-4 max-w-[11ch] text-balance text-4xl font-semibold leading-[0.95] ${
          ...
          {error ? (
            <div className="rounded-[2rem] border border-[#ff4fa2]/30 bg-[#ff4fa2]/10 p-5 text-sm leading-7 text-[#ffc1df]">
              {error}
            </div>
          ) : null}
          ...
          {!isLoading && !error ? (
            ...
            >
              ...
              <div
                className={`space-y-5 text-pretty text-[0.98rem] leading-8 ${
