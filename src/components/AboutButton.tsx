...
const GITHUB_URL = 'https://github.com/noelbrm';
    ...
    <>
      ...
      >
        <div className="flex h-full items-center justify-center">
          <div className="relative w-full max-w-2xl overflow-hidden rounded-[2rem] border border-white/10 bg-black text-white shadow-[0_40px_120px_rgba(0,0,0,0.72)]">
            <div className="relative max-h-[92vh] overflow-y-auto px-5 pb-5 pt-0 sm:px-7 sm:pb-7 sm:pt-0">
              <div className="sticky top-0 z-10 -mx-5 mb-6 flex items-center justify-end bg-black/92 px-5 pb-4 pt-5 backdrop-blur-md sm:-mx-7 sm:px-7 sm:pb-5 sm:pt-7">
                <button
                  type="button"
                  onClick={closeDialog}
        ...
        {steps.map((step, index) => (
          <article key={`${title}-${index}`}>
            <div className="flex items-start gap-3">
              <span className="mt-0.5 inline-flex min-w-6 shrink-0 items-center justify-center text-[0.82rem] font-semibold text-white/55">
                {index + 1}
              </span>
